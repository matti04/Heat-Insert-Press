...
## Introduction
Heat inserts are small brass cylinders with a thread in it. Typically used for injection moulding, they quickly became a popular way to connect 3D-printed parts. They work by melting it to a slightly smaller hole, thus making a strong connection. 
